...
namespace Assets.FantasyHeroes.Scripts
{
    ...
    public class CharacterEditor : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            InitializeDropdown(MeleeWeapon1HDropdown, SpriteCollection.MeleeWeapon1H, Dummy.Weapon, texture => { Dummy.Weapon = texture; Dummy.WeaponType = WeaponType.Melee1H; AnimationManager.Reset(); });
            InitializeDropdown(MeleeWeapon2HDropdown, SpriteCollection.MeleeWeapon2H, Dummy.Weapon, texture => { Dummy.Weapon = texture; Dummy.WeaponType = WeaponType.Melee2H; AnimationManager.Reset(); });
            InitializeDropdown(ShieldDropdown, SpriteCollection.Shield, Dummy.Shield, texture => { Dummy.Shield = texture; Dummy.WeaponType = WeaponType.Melee1H; AnimationManager.Reset(); });
        ...
        public void Save()
        {
            ...
            for (var i = 0; i < 100; i++)
            {
                ...
                {
                    PrefabUtility.CreatePrefab(path, Dummy.gameObject);
